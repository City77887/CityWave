...
export const INITIAL_EVENTS: EventData[] = [
  {
    id: 'evt-1',
    // Added missing required ownerId property
    ownerId: 'admin',
    ...
    // Added missing required minTicketSerial and maxTicketSerial properties
    minTicketSerial: 1000,
    maxTicketSerial: 9999,
    tables: [
      { id: 't-1', name: 'VIP 1', status: TableStatus.FREE },
      // Added missing reservedAt property to fix missing property error
  ...
  {
    id: 'evt-2',
    // Added missing required properties ownerId, minTicketSerial, and maxTicketSerial
    ownerId: 'admin',
